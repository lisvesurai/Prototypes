    ...
    <div class="messageContent">
    	<p>Message has been sent.</p>
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="games.jsp?p=<%=phone%>">Jogos</a>/</li>
                <li><a href="games_category.jsp?p=<%=phone%>">Categoria</a>/</li>
                <li><a href="games_subcategory.jsp?p=<%=phone%>">Subcategoria</a>/</li>
			...
			<div class="main mainSons">
            	<div class="degrade">
					...
					<div class="imgsDetalhe">
                    	<div class="fLeft">
							<div class="img"><img src="/prototypes/placeholder/16.jpg" /></div>
                        </div>
                        <div class="fRight">
                            <h3>Entrena tu Mente 2</h3>
                            <h4>Glu Mobile</h4>                            
                            <p>El juego de agilidad mental m¿s completo e innovador, ahora con mejor pinta que nunca. Haz las nuevas pruebas diarias del Dr. Lababidi, guarda los resultados en tu perfil personal y usa las funciones fotogr¿ficas y los controles t¿ctiles para convertirte en una aut¿ntica lumbrera. </p>
                        </div>
      				</div>
                    <br class="clear"/>                                 
                </div>
                	...
                	<ul>
                    	...
                    	<li class="last">
                            ...
                            <div class="listaSons push14">
                                <dl>
                                    <dd>
                                        <a href="games_details.jsp?p=<%=phone%>"><img src="ui/images/pictures/pic_imsSons.jpg" width="75" height="75" alt="Sons" /></a>
                                        <p>
                                            <a href="games_details.jsp?p=<%=phone%>">Delegada</a>
