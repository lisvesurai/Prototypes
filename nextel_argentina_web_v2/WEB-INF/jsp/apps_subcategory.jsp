<%@ include file = "../template/nextelar/tools.jsp" %>
			...
			<div class="main mainSons">
            	<div class="degrade">              
					<div class="sons">
                        ...
                        <ul>
                            ...
                            <li><a href="apps_subcategory.jsp?p=<%=phone%>">subcategoria</a></li>
                            <li><a href="apps_subcategory.jsp?p=<%=phone%>">subcategoria</a></li>
                            <li class="current"><a href="apps_subcategory.jsp?p=<%=phone%>">subcategoria</a></li>
                            <li><a href="apps_subcategory.jsp?p=<%=phone%>">subcategoria</a></li>
                            <li><a href="apps_subcategory.jsp?p=<%=phone%>">subcategoria</a></li>
                        </ul>                                                        
                         <ul>
                ...
                <div class="listaSons push14">
                	<dl>
                    	<dt>Resultados da busca por <strong>Aplicações / Subcategoria (804 resultados)</strong></dt>
                        <dd>
