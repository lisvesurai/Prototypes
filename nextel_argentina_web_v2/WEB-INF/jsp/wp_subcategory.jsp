<%@ include file = "../template/nextelar/tools.jsp" %>
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="wp_category.jsp?p=<%=phone%>">Categoria</a>/</li>
			...
			<div class="main mainSons">
            	<div class="degrade">              
					<div class="sons">
                        ...
                        <ul>
                            ...
                            <li><a href="wp_subcategory.jsp?p=<%=phone%>">subcategoria</a></li>
                            <li><a href="wp_subcategory.jsp?p=<%=phone%>">subcategoria</a></li>
                            <li class="current"><a href="wp_subcategory.jsp?p=<%=phone%>">subcategoria</a></li>
                            <li><a href="wp_subcategory.jsp?p=<%=phone%>">subcategoria</a></li>
                            <li><a href="wp_subcategory.jsp?p=<%=phone%>">subcategoria</a></li>
                        </ul>                                                        
                         <ul>
                ...
                <div class="listaSons push14">
                	<dl>
                    	<dt>Resultados da busca por <strong>Imagens / Subcategoria (804 resultados)</strong></dt>
                        <dd>
