...
<jsp:include page="inc_header.jsp" flush="true"/>
	...
	<div class="content">
		...
		<div class="blocktitle"><img src="UI/img/arrow.gif" alt="&gt;"/>&nbsp;CAT &amp; MBA Entrance Examinations</div>
		...
		<div class="item">
			<table>
				<tr>
					...
					<td class="item"><a href="item.jsp?w=<%=screenWidth%>&f=<%=fontSize%>" class="itemtitle">CAT Guru Application</a><br />
		...
		<div class="item">
			<table>
				<tr>
					<td class="itemth"><img src="devportalcontent/catguru.png" class="itemth"/></td>
					<td class="item"><a href="item.jsp?w=<%=screenWidth%>&f=<%=fontSize%>" class="itemtitle">CAT Guru Messaging</a><br />
						<img src="UI/img/<%=screenWidth%>/i_star.gif" alt="*"/><img src="UI/img/<%=screenWidth%>/i_star.gif" alt="*"/><img src="UI/img/<%=screenWidth%>/i_star.gif" alt="*"/><img src="UI/img/<%=screenWidth%>/i_star.gif" alt="*"/><img src="UI/img/<%=screenWidth%>/i_star.gif" alt="*"/><%=buyLinkLarge%></td>
				</tr>
			</table>
			<%=buyLinksSmall%>
		...
		<div class="item">
			<table>
				<tr>
					<td class="itemth"><img src="devportalcontent/CCNA.png" class="itemth"/></td>
					<td class="item"><a href="item.jsp?w=<%=screenWidth%>&f=<%=fontSize%>" class="itemtitle">CCNA Guru</a><br />
						<img src="UI/img/<%=screenWidth%>/i_star.gif" alt="*"/><img src="UI/img/<%=screenWidth%>/i_star.gif" alt="*"/><img src="UI/img/<%=screenWidth%>/i_star.gif" alt="*"/><img src="UI/img/<%=screenWidth%>/i_star.gif" alt="*"/><img src="UI/img/<%=screenWidth%>/i_star.gif" alt="*"/><%=buyLinkLarge%></td>
				</tr>
			</table>
			<%=buyLinksSmall%>
