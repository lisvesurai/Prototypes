...
<!-- begin content block -->
<div id="contentBlock">
<%--<center><br /><br /><br /><br /><br /><br /><br />&nbsp;<img src="ui/images/loadingAnimation.gif" /></center>--%>
	...
	<div class="tabs">
		<ul>
			<li id="apps_tab" class="hl" title="Tooltip text goes here. Tooltip text goes here. Tooltip text goes here. Tooltip text goes here">Aplicaciones</li>
		</ul>
	</div>
		...
		<div class="list">
			<ul>
				<li class="first">
					...
					<p class="actions"><a href="javascript:void 0;" onclick="getItemDetailsAJAX('<%=phone%>','<%=phoneName%>','<%=loginStatus%>','apps','01');return false;" class="preview">Preview</a><a href="javascript:void 0;" onclick="rateItem('<%=phone%>','<%=phoneName%>','<%=loginStatus%>','apps','01');return false;" class="rate">Rate</a><a href="javascript:void 0;" onclick="getItemDetailsAJAXBuy('<%=phone%>','<%=phoneName%>','<%=loginStatus%>','apps','01');return false;" class="buy">Buy</a></p>
				</li>
				<li>
