...
<div id="content_apps" class="content details">
	...
	<div id="preview">
		<img src="devportal_content/app_ss1.gif" alt="Preview Image" class="previewImg" />
	</div>

	<div id="description">
		<h3 class="cat">Categoría: Aplicaciones</h3>
		<h1 class="title">My Cast</h1>
	...
	<div id="tellfriend">
		...
		<div id="tellfriend_item">
			<img src="/prototypes/placeholder/63.jpg" alt="Preview Image" class="previewImg" />
			<h1 class="title">My Cast</h1>
		</div>
