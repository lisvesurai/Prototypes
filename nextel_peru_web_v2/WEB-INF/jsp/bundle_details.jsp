...
<div id="content_promo" class="content details">
	...
	<div id="preview">
		<img src="/prototypes/placeholder/26.jpg" alt="Preview Image" class="previewImg" />
	</div>

	<div id="description">
		<h3 class="cat">Categoría: Pack</h3>
		<h1 class="title">La Era de Hielo 3</h1>
	...
	<div id="purchase"><a name="purchaseitem"></a>
		...
		<div id="sendtophone">
			...
			<div class="clear"></div>
			<a href="javascript:void 0;" onclick="sendToPhone('<%=phone%>','<%=phoneName%>','<%=loginStatus%>','apps','01');return false;" class="send">ENVIAR</a>
			<%--
			<div class="select">
				<div class="selected">
					Lima
	...
	<div id="tellfriend">
		...
		<div id="tellfriendemail" class="hide">
			...
			<div class="clear"></div>
			<a href="javascript:void 0;" onclick="tellAFriend('<%=phone%>','<%=phoneName%>','<%=loginStatus%>','apps','01');return false;" class="send">ENVIAR</a>
		</div>
		<div id="tellfriendphone">
			...
			<div>
			<p>Número</p>
			<input type="text" name="recipient_phonenumber" class="recipient_phonenumber" />
			</div>
			<a href="javascript:void 0;" onclick="tellAFriend('<%=phone%>','<%=phoneName%>','<%=loginStatus%>','apps','01');return false;" class="send">ENVIAR</a>
			<%--
			<div class="select">
