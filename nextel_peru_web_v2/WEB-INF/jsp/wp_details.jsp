...
<div id="content_wp" class="content details">
	...
	<div id="preview">
		<img src="/prototypes/placeholder/24.jpg" alt="Preview Image" class="previewImg" />
	</div>

	<div id="description">
		<h3 class="cat">Categoría: Imágenes</h3>
		<h1 class="title">Donald a la mexicana</h1>
	...
	<div id="purchase"><a name="purchaseitem"></a>
		...
		<div id="sendtophone">
			...
			<div class="clear"></div>
			<a href="javascript:void 0;" onclick="sendToPhone('<%=phone%>','<%=phoneName%>','<%=loginStatus%>','wp','01');return false;" class="send">ENVIAR</a>
			<%--
			<div class="select">
				<div class="selected">
					Lima
	...
	<div id="tellfriend">
		...
		<div id="tellfriendemail" class="hide">
			...
			<div class="clear"></div>
			<a href="javascript:void 0;" onclick="tellAFriend('<%=phone%>','<%=phoneName%>','<%=loginStatus%>','wp','01');return false;" class="send">ENVIAR</a>
		</div>
