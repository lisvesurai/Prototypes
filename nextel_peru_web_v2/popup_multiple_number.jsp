...
<script src='ui/js/mam_checkbox.js' language="javascript" type="text/javascript"></script>
</head>
<body class="popup">
<div id="cm">	
...
<form name="myFormName" action="#myFormName">
		...
		<h3>Por favor, seleccione los equipos de esta página para los cuales desea comprar el "AGPS SUBS TEST".</h3>
		<h3>Debe completar el proceso de compra para los equipos seleccionados en esta página antes de pasar a la siguiente.</h3>
		<h3>Los equipos en gris no son compatibles con "AGPS SUBS TEST".</h3>
		<h3>Cantidad de equipos compatibles:4</h3>
		</div>
			...
			<table cellspacing="0" cellpadding="0">
				<thead>
					<tr>
						...
						<th class="medium">Nro.de tel&eacute;fono <a href="#"><img src="ui/images/btn_arrow_up.gif" alt="&circ;"/></a><a href="#"><img src="ui/images/btn_arrow_down.gif" alt="&nu;"/></a></th>
						<th class="medium">Nro de contracto <a href="#"><img src="ui/images/btn_arrow_up.gif" alt="&circ;"/></a><a href="#"><img src="ui/images/btn_arrow_down.gif" alt="&nu;"/></a></th>
						<th class="medium">Flota*Radio <a href="#"><img src="ui/images/btn_arrow_up.gif" alt="&circ;"/></a><a href="#"><img src="ui/images/btn_arrow_down.gif" alt="&nu;"/></a></th>
						<th class="short">Modelo <a href="#"><img src="ui/images/btn_arrow_up.gif" alt="&circ;"/></a><a href="#"><img src="ui/images/btn_arrow_down.gif" alt="&nu;"/></a></th>
						<th class="long">SubsID</th>
						<th class="short">AGPS <a href="#"><img src="ui/images/btn_arrow_up.gif" alt="&circ;"/></a><a href="#"><img src="ui/images/btn_arrow_down.gif" alt="&nu;"/></a></th>
						</tr>
				</thead>
				<tbody>
					<tr>
		...
		<p class="submitMultipleNumbers">
			<a href="javascript:void 0;" onclick="ajaxLoader('popup_multiple_number_aoc.jsp','popupContentArea');"><img src="ui/images/btn_accept.gif" alt="Aceptar" /></a>
			<a href="javascript:void 0;" onClick="document.myFormName.reset();return false;"><img src="ui/images/btn_cancel.gif" alt="Cancelar"/></a>
			<a href="javascript:void 0;" onclick="window.parent.tb_remove();"><img src="ui/images/btn_exit.gif" alt="Salir"/></a>		</p>
