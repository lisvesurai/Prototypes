...
<jsp:include page="inc_header.jsp" flush="true">
	...
	<jsp:param name="hl" value="0"/>
		...
		<div class="toptitle"><div class="toptitleinner">28 Search Results</div></div>
...
<% if (screenWidth.equals("240")||screenWidth.equals("320")) {%>
			  	<center>
				<span class="sorttxt"><input type="radio" name="sortby" class="sortby" /> Date
				<input type="radio" name="sortby" class="sortby" checked="checked" /> Title</span>
			  	...
			  	<table width="100%" cellpadding="0" cellspacing="0" class="sort">
					<tr>
						<td valign="bottom" align="left" class="sorttxt" width="50%" nowrap="nowrap">
							...
							<input type="radio" name="sortby" class="sortby" checked="checked" /> Title
						</td>
