...
<jsp:include page="inc_header.jsp" flush="true"/>
	...
	<div class="content">
		...
		<div class="link">
			<dl class="mnr">
				<dt class="mnr">&nbsp;&gt; <a href="item_rate.jsp?w=<%=screenWidth%>&f=<%=fontSize%>&s=<%=siteStr%>&tab=<%=tabStr%>" class="mnr">Rate this app</a></dt>
				<dt class="mnr">&nbsp;<img src="UI/img/facebook_icon.png" />&nbsp;<a href="facebook_share.jsp?w=<%=screenWidth%>&f=<%=fontSize%>&s=<%=siteStr%>&tab=<%=tabStr%>" class="mnr">Share on Facebook</a></dt>
			</dl>
		</div>
		...
		<div class="subtitle">Recommended apps</div>
		<div class="contentpad">
