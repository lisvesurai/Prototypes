...
<jsp:include page="inc_header.jsp" flush="true"/>
	...
	<div class="content">
		...
		<div class="sepsolid"></div><div class="item">
			...
			<div class="action">
				&nbsp;&gt; <a href="receipt.jsp?w=<%=screenWidth%>&f=<%=fontSize%>&s=<%=siteStr%>&tab=<%=tabStr%>" class="action">Buy app</a>
			</div>
			<div class="action">
				&nbsp;&gt; <a href="my_wishlist.jsp?w=<%=screenWidth%>&f=<%=fontSize%>&s=<%=siteStr%>&tab=<%=tabStr%>&msg=2" class="action">Remove</a>
			</div>
		</div>
