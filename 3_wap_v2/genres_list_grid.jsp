...
<jsp:include page="inc_header.jsp" flush="true"/>
	...
	<div class="content">
		...
		<%--<table class="pagination">
			...
			<% } %>
				<td class="pageview">view as <a href="genres_list.jsp?w=<%=screenWidth%>&f=<%=fontSize%>&s=<%=siteStr%>&tab=<%=tabStr%>">List</a> | <b>Grid</b></td>
			</tr>
		</table>--%>
		...
		<div class="link">
			<dl class="mnr">
				<dt class="mnr">&nbsp;&gt; <a href="home_cat.jsp?w=<%=screenWidth%>&f=<%=fontSize%>&s=<%=siteStr%>&tab=<%=tabStr%>" class="mnr">Browse more categories</a></dt>
			</dl>
		</div>
