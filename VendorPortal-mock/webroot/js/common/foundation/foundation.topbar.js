    ...
    sticky : function () {
      ...
      if ($(klass).length > 0) {
        var distance = $(klass).length ? $(klass).offset().top: 0,
		  ...
		  var leftnavheight = $(".side-nav-vp").height();
          ...
          $window.scroll(function() {
			...
			if ($window.scrollTop() >= (distance)) {			
			  ...
			  if ($window.scrollTop() >= (bodyheight-footerheight-offst-$window.height())) {
				  //console.log('inside 1');
				  $('body').css('padding-top','0');
				  $(klass).removeClass("fixed");
				  $(klass).css('margin-top',$window.scrollTop()-footerheight-offst);
			  }
			  else if ($window.scrollTop() < (bodyheight-footerheight-offst-$window.height())) {
				  //console.log('inside 2');
				  $('body').css('padding-top',offst);
				  $(klass).addClass("fixed");
				  $(klass).css('margin-top',offst);
			  }
			}
			else if ($window.scrollTop() < distance) {
			  //console.log('inside 3');
			  $(klass).removeClass("fixed");
			  $(klass).css('margin-top','0');
			  $('body').css('padding-top','0');
