<jsp:include page="inc_header.jsp" flush="true"/>
		...
		<div class="preview">
			...
			<div class="answer">
				<p class="desc">The Application Shop is a 3rd party managed site for Orange customers to purchase applications for use on their handsets. An application is a piece of software you can download onto your phone for personal use.</p>
				<p class="desc">A link to the Application Shop will be accessible from the Orange Internet site and from Orange World on a mobile Device.</p>
			...
			<div class="answer">
				...
				<p class="desc">At time of launch, the maximum price of an application is &pound;10.00.</p>
			...
			<div class="answer">
				<p class="desc">Should you experience any issues with downloading an application from the Application Shop, please check that your handset data settings are correctly configured in the first instance.</p>
				...
				<p class="desc">Telephone voice support is not available for the Application Shop.</p>
