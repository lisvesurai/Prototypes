...
<jsp:include page="inc_header.jsp" flush="true">
	<jsp:param name="t" value="Download Success"/>
	<jsp:param name="hl" value="0"/>
</jsp:include>

		<h1 class="toptitle_<%=screenWidth%>"><a href="home.jsp?f=<%=fontSize%>&w=<%=screenWidth%>" class="toptitle">Apps Store</a> &gt; Download Success</h1>
		
		<div class="preview">
		  <p class="desc">
		  Thanks for your order. You have successfully downloaded Driving Log to your phone.</p>
		  <p class="msg">Rs. 50 would be charged to your BSNL Account.</p>
		</div>

		<h1 class="toptitle_<%=screenWidth%>"><a href="home.jsp?f=<%=fontSize%>&w=<%=screenWidth%>" class="toptitle">Apps Store</a> &gt; Recommendations</h1>
