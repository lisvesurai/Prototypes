...
<jsp:include page="inc_header.jsp" flush="true">
	...
	<jsp:param name="hl" value="5"/>
		...
		<div class="preview">
		<p class="msg">Your request to download [Title] from BSNL Apps Store could not be processed due to low balance. Please recharge your account or purchase a version with a lower price. [title] has been added to your My Favourites list.</p>
		</div>
		...
		<table class="itemDetails" border="0" cellpadding="0" cellspacing="0">
			<tr valign="top">
				...
				<td class="details">
					...
					<h4 class="price"><form>
					<!--<input type="radio" name="price" checked="checked" />Free trial for 3 min<br />-->
					<input type="radio" name="price" checked="checked" />Rs. 150 - one time<br />
					<input type="radio" name="price" />Rs. 15/month<br /><input type="radio" name="price" />Rs. 5/week<br /><input type="radio" name="price" />Rs. 2/day
					</form></h4>
		...
		<div class="even">
			...
			<a class="red" href="item3.jsp?f=<%=fontSize%>&w=<%=screenWidth%>&t=Driving%20Log%202&msg=4">Remove from favorites</a>
			<% } else { %>
			<a class="red" href="item3.jsp?f=<%=fontSize%>&w=<%=screenWidth%>&t=Driving%20Log%202&msg=3&fav=yes">Add to favorites</a>
			<% } %>
		</div>		
