...
else strCatTitle = "Entertainment ";
	...
	int i = Integer.parseInt( msg ) ;
  	switch ( i ) {
		...
		case 2 : 
			...
			break ;
		case 3 : 
			msgStr = "<p class=\"msg\">This app has been added to your  favorites.</p>";
			break ;
		case 4 : 
			msgStr = "<p class=\"msg\">This app has been removed from your favorites.</p>";
			break ;
		case 5 : 
			msgStr = "<p class=\"msg\">Please enter your friend&rsquo;s BSNL mobile number.</p>";
			break ;
		default : 
			msgStr = "";
			break ;
