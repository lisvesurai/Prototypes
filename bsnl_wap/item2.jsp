...
<jsp:include page="inc_header.jsp" flush="true">
	...
	<jsp:param name="hl" value="5"/>
		...
		<div class="even">
			...
			<a class="red" href="item2.jsp?f=<%=fontSize%>&w=<%=screenWidth%>&t=Driving%20Log%202&msg=4">Remove from favorites</a>
			<% } else { %>
			<a class="red" href="item2.jsp?f=<%=fontSize%>&w=<%=screenWidth%>&t=Driving%20Log%202&msg=3&fav=yes">Add to favorites</a>
			<% } %>
		</div>		
