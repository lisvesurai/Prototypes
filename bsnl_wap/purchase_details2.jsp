...
<jsp:include page="inc_header.jsp" flush="true">
	...
	<jsp:param name="hl" value="7"/>
		...
		<table class="itemDetails" border="0" cellpadding="0" cellspacing="0">
			<tr valign="top">
				...
				<td class="details">
					...
					<p class="btn"><a href='#'><img src="UI/img/btn_cancel.gif" alt="Cancel" /></a></p>
				</td>
			</tr>
		</table>
		<div class="even">
			<span class="tt">Valid Till Date:</span> 01/06/2009
		</div>
		<div class="odd">
			<span class="tt">Renewal Frequency:</span> Monthly
		</div>
		<div class="even">
		...
		<div class="odd">
			<span class="tt">Renewal Frequency:</span> Monthly
			<p align="right"><a href='#'><img src="UI/img/btn_cancel.gif" alt="Cancel" /></a></p>
		</div>
		<div class="even">
