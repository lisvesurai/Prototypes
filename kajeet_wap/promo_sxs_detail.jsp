...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
  ...
  <body>
    <div id="container">
      <div id="headerbg">
        <h1 class="header">&lt;Promo Title&gt;</h1>
      </div>
      <div id="promo">
        <img src='images/kajeet/<%= request.getParameter("w") %>_banner_s.png' alt="Promo" class="promo_small"/>
		<p class="promodesc">&lt;SxS Promo description&gt;</p>
      </div>
      <div id="body">
        <div class="results">
          <dl class="mnr">
            ...
            <dt class="mnr">n. <a accesskey="6" title="OK" href='apps_offer.jsp?w=<%= request.getParameter("w") %>&u=<%= request.getParameter("u") %>'>Title</a></dt>
          </dl>
          <dl class="page">
