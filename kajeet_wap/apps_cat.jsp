    ...
    <div id="container">
      ...
      <div id="body">
        <div class="results">
          ...
          <dl class="mnr_cat">
            <dt class="mnr_cat">6. <a accesskey="6" title="OK" href='apps_cat.jsp?w=<%= request.getParameter("w") %>&u=<%= request.getParameter("u") %>' class="mnr_cat">Category #1</a></dt>
            <dt class="mnr_cat">7. <a accesskey="7" title="OK" href='apps_cat.jsp?w=<%= request.getParameter("w") %>&u=<%= request.getParameter("u") %>' class="mnr_cat">Category #2</a></dt>
            <dt class="mnr_cat">8. <a accesskey="8" title="OK" href='apps_cat.jsp?w=<%= request.getParameter("w") %>&u=<%= request.getParameter("u") %>' class="mnr_cat">Category #3</a></dt>
            <dt class="mnr_cat">9. <a accesskey="9" title="OK" href='apps_cat.jsp?w=<%= request.getParameter("w") %>&u=<%= request.getParameter("u") %>' class="mnr_cat">Category #4</a></dt>
          </dl>
          <dl class="page">
