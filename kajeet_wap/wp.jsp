    ...
    <div id="container">
      ...
      <div id="body">
        <dl class="mnr">
		  ...
		  <dt class="mnr">4. <a accesskey="4" title="OK" href='wp_list.jsp?w=<%= request.getParameter("w") %>&u=<%= request.getParameter("u") %>'>What's New</a></dt>
		  <dt class="mnr">5. <a accesskey="5" title="OK" href='wp_list.jsp?w=<%= request.getParameter("w") %>&u=<%= request.getParameter("u") %>'>Featured</a></dt>
		  <dt class="mnr">6. <a accesskey="6" title="OK" href='wp_cat.jsp?w=<%= request.getParameter("w") %>&u=<%= request.getParameter("u") %>'>Browse by Category</a></dt>
		  <dt class="mnr">7. <a accesskey="7" title="OK" href='search.jsp?w=<%= request.getParameter("w") %>&u=<%= request.getParameter("u") %>'>Search</a></dt>
		  <dt class="mnr">8. <a accesskey="8" title="OK" href='wp_recommend.jsp?w=<%= request.getParameter("w") %>&u=<%= request.getParameter("u") %>'>You May Also Like...</a></dt>
		</dl>
      </div>
	  <div id="footer">
