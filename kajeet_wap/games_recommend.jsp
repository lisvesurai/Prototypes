      ...
      <div id="body">
		...
		<img src='images/kajeet/<%= request.getParameter("w") %>_h_games.gif' alt="Games"/>
		  <dl class="mnr">
            ...
            <dt class="mnr">5. <a accesskey="5" title="OK" href='games_offer.jsp?w=<%= request.getParameter("w") %>&u=<%= request.getParameter("u") %>'>More Games...</a></dt>
          </dl>
		...
		<img src='images/kajeet/<%= request.getParameter("w") %>_h_ringtones.gif' alt="Ringtones"/>
		  <dl class="mnr">
            <dt class="mnr"><b class="space">&nbsp;&nbsp;&nbsp;</b> <a title="OK" href='rt_offer.jsp?w=<%= request.getParameter("w") %>&u=<%= request.getParameter("u") %>'>Title</a></dt>
            <dt class="mnr"><b class="space">&nbsp;&nbsp;&nbsp;</b> <a title="OK" href='rt_offer.jsp?w=<%= request.getParameter("w") %>&u=<%= request.getParameter("u") %>'>Title</a></dt>
            <dt class="mnr"><b class="space">&nbsp;&nbsp;&nbsp;</b> <a title="OK" href='rt_offer.jsp?w=<%= request.getParameter("w") %>&u=<%= request.getParameter("u") %>'>Title</a></dt>
            <dt class="mnr"><b class="space">&nbsp;&nbsp;&nbsp;</b> <a title="OK" href='rt_offer.jsp?w=<%= request.getParameter("w") %>&u=<%= request.getParameter("u") %>'>Title</a></dt>
            <dt class="mnr"><b class="space">&nbsp;&nbsp;&nbsp;</b> <a title="OK" href='#'>More Ringtones...</a></dt>
		  </dl>
