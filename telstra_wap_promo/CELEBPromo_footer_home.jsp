<%@ include file = "inc_waptools.jsp" %>
	  ...
	  <div id="footer">
          <dl class="ftr">
            <dt class="ftr">
              <img src="images/promoimages/CELEBPromo_ftr.gif" class="ftr" align="baseline"/>
              <a href='http://celebrity.wap.bigpond.com' class="afooterlink">Celebrity + Fashion Home</a>
			</dt>
