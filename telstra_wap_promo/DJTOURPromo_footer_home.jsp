<%@ include file = "inc_waptools.jsp" %>
	  ...
	  <div id="footer">
          <dl class="ftr">
            <dt class="ftr">
              <img src="images/promoimages/generic_promo_arrow_ftr.gif" class="ftr" align="baseline"/>
              <a href='DJTOURPromo.jsp?a=<%=userAgent%>&w=<%=screenWidth%>' class="afooterlink">Promo Home</a>
			</dt>
