...
<head>
<title>NRL Trivia Challenge</title>
...
<div id="container">
	<div id="body">
		...
		<!-- begin title -->
		<h1 class="title"><img src="images/805/NRLPromo_banner_<%=screenWidth%>.gif" alt="NRL Trivia Challenge"/></h1>
		<!-- end title -->
...
<p>(b)	purchase from the Promoter the NRL Trivia ("Game") and download it onto their mobile phone ("Eligible Purchase");</p>
...
<p>23.	The Promoter accepts no responsibility for any tax liabilities that may arise from winning the prize.</p>
		...
		<div class="link">
		  <dl>
			<dt class="mnr">
			  ...
			  <a class="mnr" href='http://telstra3g.cellmania.com/xhtml/deepsearch.do?cat=Games&list=true&keyword=NRL+Trivia+Challenge&schannel=NRLPromo'>Buy &amp; Play NRL Trivia Challenge</a>
			</dt>
		  </dl>
		</div>
		<!-- end link -->
	...
	<jsp:include page="NRLPromo_footer_home.jsp" flush="true"/>
