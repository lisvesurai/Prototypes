...
<jsp:include page="inc_header.jsp" flush="true">
	...
	<jsp:param name="pageTitle" value="Rental Bundle #2 Name"/>
</jsp:include>
	...
	<dl class="mnr">
		<dt class="mnr"><a class="mnr" href="game_details.jsp?rental=return&t=Driving+Log+2&s=<%=styleStr%>">Driving Log 2</a> <a href="rentalbundle_return_confirm.jsp?t=Driving+Log+2&s=<%=styleStr%>">[Return]</a></dt>
		<dt class="mnr"><a class="mnr" href="game_details.jsp?rental=return&t=Webdate+Mobile&s=<%=styleStr%>">Webdate Mobile</a> <a href="rentalbundle_return_confirm.jsp?t=Webdate+Mobile&s=<%=styleStr%>">[Return]</a></dt>
	</dl>
