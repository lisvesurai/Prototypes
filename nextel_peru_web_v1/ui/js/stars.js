...
Stars.prototype = {
	...
	initialize: function(options)
	{
		...
		this.options = {
			...
			imagePath: 'ui/images/',		// Path to star images
		 ...
		 */
		this._starSrc = {
			empty: this.options.imagePath + "i_star_empty.gif",
			full: this.options.imagePath + "i_star.gif",
			half: this.options.imagePath + "i_star_half.gif"
		};
		/**
		 * Preload images
		 */
