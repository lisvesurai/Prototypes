...
<div id="content_videos" class="content">
	...
	<div id="categories">
		...
		<ul id="categoryListings">
			<li title="Programas de TV"><a href="#">Programas ..</a></li>
			<li title="Musicales"><a href="#">Musicales</li>
			<li title="Trailers de películas"><a href="#">Trailers d..</li>
		</ul>
	</div>

	<div class="tabs">
		<ul>
			<li id="videos_tab" class="hl" title="Videos musicales y más categorías">Videos</li>
		</ul>
	</div>
	...
	<div id="catlist">
		<div class="list">
			<ul>
				<li class="first">
					<p class="bg"></p>
					<p class="th"><img src="devportal_content/video1.jpg" alt="" /></p>
				...
				<li>
					<p class="bg"></p>
					<p class="th"><img src="devportal_content/video2.jpg" alt="" /></p>
				...
				<li>
					<p class="bg"></p>
					<p class="th"><img src="devportal_content/video3.jpg" alt="" /></p>
					<p class="title">Shazam</p>
					<p class="price">S/. 50,00 - $ 15,00</p>
				...
				<li>
					<p class="bg"></p>
					<p class="th"><img src="devportal_content/video4.jpg" alt="" /></p>
					<p class="title">Shazam</p>
					<p class="price">S/. 50,00 - $ 15,00</p>
				...
				<li class="last">
					<p class="bg"></p>
					<p class="th"><img src="devportal_content/video5.jpg" alt="" /></p>
					<p class="title">Shazam</p>
					<p class="price">S/. 50,00 - $ 15,00</p>
