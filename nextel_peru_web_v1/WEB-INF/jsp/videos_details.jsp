...
<div id="content_videos" class="content details">
	...
	<div id="previewvideo" onmouseover="$('videoSS').className='hide';$('videoPlayBtn').className='hide';">
		<img src="devportal_content/vdo_ss1.jpg" alt="Preview Image" class="previewImg" id="videoSS" /><a href="devportal_content/video2.flv" class="play"  id="videoPlayBtn">Play</a>
	</div>

	<div id="description">
		<h3 class="cat">Categoría: Videos</h3>
	...
	<div id="purchase"><a name="purchaseitem"></a>
		...
		<div id="sendtophone">
			...
			<div class="clear"></div>
			<a href="javascript:void 0;" onclick="sendToPhone('<%=phone%>','<%=phoneName%>','<%=loginStatus%>','videos','01');return false;" class="send">ENVIAR</a>
			<%--
			<div class="select">
				<div class="selected">
					Lima
	...
	<div id="tellfriend">
		...
		<div id="tellfriend_item">
			<img src="devportal_content/vdo_th2.jpg" alt="Preview Image" class="previewImg" />
		...
		<div id="tellfriendemail" class="hide">
			...
			<div class="clear"></div>
			<a href="javascript:void 0;" onclick="tellAFriend('<%=phone%>','<%=phoneName%>','<%=loginStatus%>','videos','01');return false;" class="send">ENVIAR</a>
		</div>
