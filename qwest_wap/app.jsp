...
<div id="logo"><img src="images/logo.gif" alt="Qwest" /></div>
	...
	<div class="banner">
		<a href="app_details.jsp"><img src="images/app_banner.gif" alt="Banner" class="banner"></a>
	</div>

	<dl>
		<dt class="mnr">1 <a href="app_top.jsp" accesskey="1">Top Applications</a></dt>
		...
		<dt class="mnr">5 <a href="app_by_genre.jsp" accesskey="5">Browse by Genre</a></dt>
		<dt class="mnr">6 <a href="app_by_title.jsp" accesskey="6">Browse By Title</a></dt>
		<dt class="mnr">7 <a href="app_vault.jsp" accesskey="7">Vault - Apps</a></dt>
	</dl>
