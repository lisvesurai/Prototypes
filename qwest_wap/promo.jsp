...
<div id="logo"><img src="images/logo.gif" alt="Qwest" /></div>
	<div class="h1">PROMOTIONS</div>
	<dl>
		<dt class="mnr">1 <a href="promo_landing.jsp" accesskey="1">Las Vegas Summer Promotion</a></dt>
		<dt class="mnr">2 <a href="promo_landing.jsp" accesskey="2">...</a></dt>
	</dl>
