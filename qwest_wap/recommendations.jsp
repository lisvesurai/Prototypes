...
<div id="logo"><img src="images/logo.gif" alt="Qwest" /></div>
	<div class="h1">QWEST RECOMMENDS</div>
	<p>Here are some recommendations based on what people who bought the same items as you are buying:</p>
	<dl>
		<dt class="mnr">1 <a href="game_details.jsp" accesskey="1">Game 1</a></dt>
		<dt class="mnr">2 <a href="rt_details.jsp" accesskey="2">Ringtone 1</a></dt>
		<dt class="mnr">3 <a href="game_details.jsp" accesskey="3">Game 2</a></dt>
		<dt class="mnr">4 <a href="wp_details.jsp" accesskey="4">Wallpaper 1</a></dt>
	</dl>
