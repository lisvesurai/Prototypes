...
var tb_pathToImage = "images/cm/loading.gif";
	...
	try {
		if (typeof document.body.style.maxHeight === "undefined") {//if IE 6
			...
			if(document.getElementById("TB_overlay") === null){
				$j("body").append("<div id='TB_overlay'></div><div id='TB_window'>");
				$j("#TB_overlay").click(tb_remove);
			}
		}
	   ...
	   var urlType = baseURL.toLowerCase().match(urlString);
		...
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'){//code to show images
			...
			$j("#TB_window").append("<a href='' id='TB_ImageOff' title='Close'><img id='TB_Image' src='"+url+"' width='"+imageWidth+"' height='"+imageHeight+"' alt='"+caption+"'/></a>"); 		
			...
			if(url.indexOf('TB_iframe') != -1){				
					...
					$j("#TB_window").append("<iframe border='0' frameborder='0' framespacing='0' scrolling='no' hspace='0' src='"+urlNoQuery[0]+"' id='TB_iframeContent' name='TB_iframeContent' style='width:"+(ajaxContentW + 29)+"px;height:"+(ajaxContentH + 18)+"px;' onload='tb_showIframe()'> </iframe>");
				}else{
