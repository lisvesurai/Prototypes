...
<div id="cmBody">
	...
	<div class="box">
		<div class="descBox">
			<div id="displayPreview">
				<img src="images/samples/gps_115x105.gif" id="preview_img" />

				<div id="preview_btn">
					<ul class="preview_images">
						<li onmouseover="updatePreviewImg(this,'images/samples/gps_115x105.gif');" onfocus="updatePreviewImg(this,'images/samples/fifa_115x105.gif');" class="hl">1</li>
			...
			<div id="detail">
				...
				<%--
				<p class="back"><a href="apps.jsp?c=apps&p=<%=phone%>&pn=<%=phoneName%>&u=<%=loginStatus%>">Volver</a></p>
				--%>
			</div>
		</div>
	</div>
	...
	<div class="box">
		<div class="priceBox">
			...
			<div class="price">
				<p class="price"><input type="radio" name="price" />Cargo por Única Vez: $4,75 + Impuestos <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<small>(Uso Ilimitado)</small></p>
				<p class="price"><input type="radio" name="price" />Cargo Mensual: $1,75 + Impuestos<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<small>(Subscripción)</small></p>
			</div>
			<div class="terms">
	...
	<div class="box">
		<div class="msgBox">
			...
			<%--<p>La descarga del contenido podrá iniciarse una vez finalizado el proceso de compra. </p>--%>
<span id="phone_statusmsg"><p>Por favor, espere que se está enviado un mensaje al equipo...</p></span>
			<span id="agps_msg_id" style="display: none;">
				...
				<p align="center">
					...
					<img src="images/cm/btn_accept.gif" alt="Aceptar" onclick="sendtoPhone('rad_price',$('commonForm'),'Y');">
					<img src="images/cm/btn_cancel.gif" alt="Cancelar" onclick="$('phone_statusmsg').innerHTML='';$('agps_msg_id').innerHTML='';">
