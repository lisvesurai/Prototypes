...
<div id="bigcontainer">
	<jsp:include page="WEB-INF/template/telkomsel/header.jsp" flush="true">
		<jsp:param name="headerTxt" value="Thanks!"></jsp:param>
		<jsp:param name="pageStr" value="feedback"></jsp:param>
	</jsp:include>

	<div id="cmcontent">
		<jsp:include page="WEB-INF/jsp/feedback_sent.jsp" flush="true"/>
	</div>
