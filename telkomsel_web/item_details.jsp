...
<div id="bigcontainer">
	<jsp:include page="WEB-INF/template/telkomsel/header.jsp" flush="true">
		<jsp:param name="headerTxt" value="Rincian Aplikasi"></jsp:param>
		<jsp:param name="pageStr" value="details"></jsp:param>
	</jsp:include>

	<div id="cmcontent">
		<jsp:include page="WEB-INF/jsp/item_details.jsp" flush="true"/>
	</div>
