...
<div id="bigcontainer">
	<jsp:include page="WEB-INF/template/telkomsel/header.jsp" flush="true">
		<jsp:param name="headerTxt" value="JAMINAN HUKUM"></jsp:param>
		<jsp:param name="pageStr" value="disclaimer"></jsp:param>
	</jsp:include>

	<div id="cmcontent">
		<jsp:include page="WEB-INF/jsp/disclaimer.jsp" flush="true"/>
	</div>
