...
<div class="content">
					...
					<div class="appsListContent">
						<ul>
							<li title="JamesCameronsAvatar">
								...
								<p class="title"><a href="javascript:void 0" onclick="getItemDetails('','7553','0','','','1');return false;" title="JamesCameronsAvatar">JamesCamer..</a></p>
								<p class="cat">Games</p>
	...
	<div class="pagination_container">
		<ul>
			...
			<li>4</li>
			<li>5</li>
			<li class="previous">&lt;&lt; Sebelumnya</li>
			<li class="next">Berikutnya &gt;&gt;</li>
		</ul>
	</div>
