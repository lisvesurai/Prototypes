...
<jsp:include page="inc_header.jsp" flush="true"/>
	...
	<dl>
		<dt class="mnr">1 <a href="game_login.jsp?w=<%=screenWidth%>" accesskey="1">Fatura</a></dt>
		<dt class="mnr">2 <a href="game_login.jsp?w=<%=screenWidth%>" accesskey="2">Pr&eacute;-Pago</a></dt>		
	</dl>	
