...
<jsp:include page="inc_header.jsp" flush="true"/>
	...
	<p>Obrigado pro comprar <span class="title">Beyonce Album Pacote</span>.</p>
	<p>O número da compra é <span class="order_num">12345</span>.</p>
	<dl>
		<dt class="mnr">1 <a href="bundle_download_success.jsp?w=<%=screenWidth%>" accesskey="1">Download</a></dt>
	</dl>
	<hr />
