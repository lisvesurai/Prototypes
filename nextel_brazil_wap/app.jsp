...
<jsp:include page="inc_header.jsp" flush="true"/>
	<h1><img src="img/<%=screenWidth%>/seta002.gif" />&nbsp;APLICAÇÕES</h1>
	<div class="banner">
		<a href="app_details.jsp?w=<%=screenWidth%>"><img src="images/app_banner.gif" alt="Banner" class="banner"></a>
	</div>

	<dl>
		<dt class="mnr">1 <a href="app_top.jsp?w=<%=screenWidth%>" accesskey="1">Top Aplicações</a></dt>
		...
		<dt class="mnr">6 <a href="app_by_title.jsp?w=<%=screenWidth%>" accesskey="6">Por Título</a></dt>
