...
<jsp:include page="inc_header.jsp" flush="true"/>
	<h1><img src="img/<%=screenWidth%>/seta002.gif" />&nbsp;PAGAMENTO</h1>
	<p>Por favor selecione a opção de pagamento:</p>
	<dl>
		<dt class="mnr">1 <a href="game_gift_login.jsp?w=<%=screenWidth%>" accesskey="1">Fatura</a></dt>
		<dt class="mnr">2 <a href="game_gift_login.jsp?w=<%=screenWidth%>" accesskey="2">Pr&eacute;-Pago</a></dt>		
	</dl>	
