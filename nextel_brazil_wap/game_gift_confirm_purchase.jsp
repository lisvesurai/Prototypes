...
<jsp:include page="inc_header.jsp" flush="true"/>
	<h1><img src="img/<%=screenWidth%>/seta002.gif" />&nbsp;CONFIRMAR COMPRA</h1>
	<h2>Gift Frogger</h2>
	<p>Esta compra será cobrada na fatura.</p>
	<dl>
		<dt class="mnr">&gt; <a href="game_gift_pmnt.jsp?w=<%=screenWidth%>">Comprar R$7,99 - Uso Ilimitado</a></dt>
		<dt class="mnr">&gt; <a href="game_details.jsp?w=<%=screenWidth%>">Cancelar</a></dt>
		<dt class="mnr">&gt; <a href="terms.jsp?w=<%=screenWidth%>">Termos</a></dt>
	</dl>
