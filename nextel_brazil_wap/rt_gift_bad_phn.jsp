...
<jsp:include page="inc_header.jsp" flush="true"/>
	...
	<p>Dê de presente <span class="title">We Belong Together - Mariah Carey - Poly</span> para um amigo.</p>
	<p class="msg">Desculpe, este não é um número Nextel válido.</p>
	<p>Por favor, digite novamente o número (Ex: 117711xxxx)</p>
	<form>
	<input class="text" name="phone_num" type="text" />
	</form>
	<dl>
		<dt class="mnr">&gt; <a href="rt_gift_confirm_purchase.jsp?w=<%=screenWidth%>">Ir</a></dt>
