...
<jsp:include page="inc_header.jsp" flush="true"/>
	<h1><img src="img/<%=screenWidth%>/seta002.gif" />&nbsp;DIVERSOS</h1>
	<p>1-2 of 2</p>
	<dl>
		<dt class="mnr">1 <a href="app_details.jsp?w=<%=screenWidth%>" accesskey="1">Driving Log 2</a></dt>
		<dt class="mnr">2 <a href="app_details.jsp?w=<%=screenWidth%>" accesskey="2">MapQuest Find Me</a></dt>
	</dl>
