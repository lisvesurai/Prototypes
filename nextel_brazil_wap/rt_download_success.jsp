...
<jsp:include page="inc_header.jsp" flush="true"/>
	<h1><img src="img/<%=screenWidth%>/seta002.gif" />&nbsp;DOWNLOAD EFETUADO COM SUCESSO</h1>
	<p>Obrigado pro comprar <span class="title">Crazy in Love - Beyonce</span>.</p>
	<dl>
		<dt class="mnr">1 <a href="rt_tell_friend.jsp?w=<%=screenWidth%>" accesskey="1">Indique para um amigo</a></dt>
	</dl>
	<hr />
