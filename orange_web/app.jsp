...
<head>
<title>Orange downloads &#45; applications</title>
...
<jsp:include page="WEB-INF/template/orange/header.jsp" flush="true"/>
	...
	<div id="mainContainer">
		<div id="contentContainer">
			...
			<jsp:include page="WEB-INF/template/orange/phone.jsp" flush="true"/>

			<jsp:include page="WEB-INF/template/orange/leftnav.jsp" flush="true"/>

			<jsp:include page="WEB-INF/jsp/app.jsp" flush="true"/>
