...
function sendToPhone(x){
	...
	if (phoneModel=='ALL'){
		document.getElementById('errMsg').innerHTML = 'Select a phone in the upper left. Boost wants your phone to work with what you want to buy.';
		return false;
	}
	else{
...
function updateTellFriendForm(el){
	document.getElementById('phoneBox').className = 'hide';
...
function displayPreview(This){
	getPreviewObjnostyle().innerHTML = '<div id="PreviewLayer_innercontainer"><img src="' + This + '"/></div>';
