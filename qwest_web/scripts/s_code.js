...
var s_linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,doc,pdf,xls,wmv,swf"
var s_linkInternalFilters="javascript:,interprise,qwest,uswest,q.com,lci,ridethelight,cybersolutions,northwesternbell,litel,qwestinteractive.com,qintra,qwestwireless.com"
var s_linkLeaveQueryString=false
var s_linkTrackVars="s_eVar6,s_eVar7,s_eVar9"
var s_linkTrackEvents="None"
/* Plugin Config */
var s_usePlugins=true
function s_doPlugins() {
	/* Add calls to plugins here */
	s_vp_getCGI('s_prop1','refCode');
	s_vp_getCGI('s_campaign','refCode');
	s_setDetailPaging('s_pageName','s_prop2');
	s_vp_getCGI('s_eVar15','IQ_ID');
}
...
/*
 * Plugin: Set Detailed Page
 */
function s_setDetailPaging(orig,detail)
	{s_vpr("st_prop","");
	s_stmppg("s_campaign","Campaign");
	s_vpr(detail,s_vp_getValue(orig)+s_vp_getValue("st_prop"));function
	s_stmppg(k,w){if(s_vp_getValue(k)){s_vpr("st_prop",s_vp_getValue(
	"st_prop")+" | "+w+"-"+s_vp_getValue(k));}}}
/*
