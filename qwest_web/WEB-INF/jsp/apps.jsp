				...
				<div class="gradientModule gTall">
					<div class="gradientModuleContent">
						...
						<div class="categoryBrowse">
							<ul>
								<li><a href='apps_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>GPS</a></li>
								<li><a href='apps_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>Lifestyle</a></li>
								<li><a href='apps_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>Family</a></li>
								<li><a href='apps_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>News &amp; Weather</a></li>
								<li><a href='apps_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>Finance</a></li>
								<li><a href='apps_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>Sports &amp; Entertain...</a></li>
								<li><a href='apps_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>Business Solutions</a></li>
								<li><a href='apps_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>Productivity</a></li>
								<li><a href='apps_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>En Espanol</a></li>
								<li class="browseAll"><a href='apps_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>Browse all</a></li>
							</ul>									
							<div class="clear"></div>
						</div>
				...
				<div class="mediaGrid mediaList">
					...
					<div class="mediaListing">
						<table cellspacing="0" cellpadding="0">
							<tr>
								<td class="gridFirst">
									<a href='apps_details.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>
