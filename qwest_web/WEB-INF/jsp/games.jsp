				...
				<div class="gradientModule gTall">
					<div class="gradientModuleContent">
						...
						<div class="categoryBrowse">
							<ul>									
								<li><a href='games_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>Retro &amp; Arcade</a></li>
								<li><a href='games_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>Puzzle</a></li>
								<li class="browseAll"><a href='games_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>Browse all</a></li>
								<li><a href='games_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>Kids &amp; Family</a></li>
								<li><a href='games_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>Sports &amp; Racing</a></li>
								<li><a href='games_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>Action &amp; Adventure</a></li>
								<li><a href='games_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>TV &amp; Movie</a></li>
								<li><a href='games_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>Card &amp; Board</a></li>
								<li><a href='games_by_category.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>En Espanol</a></li>
							</ul>									
							<div class="clear"></div>
						</div>
				...
				<div class="mediaGrid mediaList">
					...
					<div class="mediaListing">
						<table cellspacing="0" cellpadding="0">
							<tr>
								<td class="gridFirst">
									<a href='#games_details.jsp?p=<%= request.getParameter("p") %>&u=<%= request.getParameter("u") %>'>
