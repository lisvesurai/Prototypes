...
<jsp:include page="inc_header.jsp" flush="true">
	...
	<p><a href="rentalbundle_mypurchases_details.jsp?credit=<%=haveCredit%>&sub=<%=subscribe%>&s=<%=styleStr%>"><img src="images/<%=styleStr%>/btn_managerentals.gif" alt="Manage Rentals" /></a></p>
	<hr />
