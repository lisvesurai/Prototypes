...
<jsp:include page="inc_header.jsp" flush="true">
	...
	<dl class="mnr">
		<dt class="mnr"><a class="mnr" href="app_browse.jsp?promo=yes&credit=<%=haveCredit%>&sub=<%=subscribe%>&cat=FINANCE&s=<%=styleStr%>">Finance</a></dt>
		<dt class="mnr"><a class="mnr" href="app_browse.jsp?promo=yes&credit=<%=haveCredit%>&sub=<%=subscribe%>&cat=GPS&s=<%=styleStr%>">GPS</a></dt>
		<dt class="mnr"><a class="mnr" href="app_browse.jsp?promo=yes&credit=<%=haveCredit%>&sub=<%=subscribe%>&cat=LIFESTYLE&s=<%=styleStr%>">Lifestyle</a></dt>
	</dl>	
