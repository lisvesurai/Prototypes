...
<jsp:include page="inc_header.jsp" flush="true">
	...
	<%= msgStr %>
	<p>Tell another friend about <span class="title"><%=titleStr%> - <%=byStr%></span>.</p>
	...
	<p>&lt; back to <a href="rt_details.jsp?promo=<%=isPromo%>&credit=<%=haveCredit%>&sub=<%=subscribe%>&t=<%=titleStr%>&by=<%=byStr%>&s=<%=styleStr%>"><%=titleStr%> - <%=byStr%></a></p>
