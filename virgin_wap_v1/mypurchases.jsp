...
<jsp:include page="inc_header.jsp" flush="true">
	...
	<dl class="mnr">
		...
		<dt class="mnr"><a class="mnr" href="app_mypurchases_details2.jsp?credit=<%=haveCredit%>&sub=<%=subscribe%>&t=Mobile+Bartender&s=<%=styleStr%>">Mobile Bartender</a></dt>
		<dt class="mnr"><a class="mnr" href="app_mypurchases_details.jsp?credit=<%=haveCredit%>&sub=<%=subscribe%>&t=NFL+Mobile&s=<%=styleStr%>">NFL Mobile</a></dt>
