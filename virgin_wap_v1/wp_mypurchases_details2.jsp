...
<jsp:include page="inc_header.jsp" flush="true">
	...
	<p>Part of Bundle: <a class="mnr" href="bundle_mypurchases_details.jsp?credit=<%=haveCredit%>&sub=<%=subscribe%>&t=Wallpaper+Subscription&type=7&s=<%=styleStr%>">Wallpaper Subscription</a></p>
