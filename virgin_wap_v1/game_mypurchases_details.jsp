...
<jsp:include page="inc_header.jsp" flush="true">
	...
	switch ( iStatus ) {
		case 1 : 
	%>
		<form action="game_purchase_success.jsp" method="get">
	...
	%>
		<dl class="mnr">
			...
			<dt class="mnr"><a class="mnr" href="game_mypurchases_details.jsp?credit=<%=haveCredit%>&sub=<%=subscribe%>&status=1&msg=8&t=<%=titleStr%>&s=<%=styleStr%>">Unsubscribe</a></dt>
