...
<jsp:include page="inc_header.jsp" flush="true">
	...
	<jsp:param name="hl" value="0"/>
		...
		<p class="txt">Thank you for ordering [bundle name]. This order will appear on your mobile.</p>
		<p class="txt"><b>Order No. xxxxx</b></p>
		<p class="txt">Below are links to download each of the items:</p>
		<p class="txt"><a href="#" class="btn1">Download link 1</a></p>
		<p class="txt"><a href="#" class="btn1">Download link 2</a></p>
		<p class="txt"><a href="#" class="btn1">Download link 3</a></p>
