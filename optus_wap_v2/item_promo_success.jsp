...
<jsp:include page="inc_header.jsp" flush="true">
	...
	<jsp:param name="hl" value="0"/>
		...
		<div class="itemdetails"><div class="itemdetailsinner"><div class="itemdetailsinner2"><div class="itemdetailsinner3">
			...
			<div class="sshot"><img src="/prototypes/placeholder/10.jpg" class="th" /></div>
			...
			<h1 class="itemTitle">Ringtone Editor testing long long long name</h1>
			<h4 class="price">Price: $1.25 <span style="text-decoration:line-through;">($5.99)</span></h4>
			...
			<p class="msg2">Code Successful</p>
			<p class="error">Please see full promotion T&amp;C's <a class="error" href="promo_tc.jsp?f=<%=fontSize%>&w=<%=screenWidth%>&ui=<%=strUI%>">here</a>.</p>
