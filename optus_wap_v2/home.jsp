...
<jsp:include page="inc_header.jsp" flush="true">
	...
	<div class="banner">		
            <a href="item.jsp?f=<%=fontSize%>&w=<%=screenWidth%>&ui=<%=strUI%>"><img src="samples/banner_app_of_week<%=strUI%>.jpg" class="banner" /></a>
        </div>
		...
		<div class="listing">
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <% if (!screenWidth.equals("120")) {%><td class="th"><img src="UI/img/no_preview_40x40.gif" /></td><% } %>
