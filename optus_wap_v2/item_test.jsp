...
<jsp:include page="inc_header.jsp" flush="true">
	...
	<jsp:param name="hl" value="0"/>
        ...
        <form action="receipt.jsp" method="get">
            ...
            <div class="sshot"><img src="/prototypes/placeholder/61.jpg" class="th_large" /></div>
            <% } %>

			<table border="0" cellspacing="0" cellpadding="0">
            	<tr valign="top">
                    <% if (!screenWidth.equals("120")) {%>
                	<td class="sshot_large" rowspan="3"><img src="/prototypes/placeholder/61.jpg" class="th_large" /></td>
                    <% } %>
