...
var flvwidth = '120' 	// Width of the flv player
var flvheight = '92'	// Height of the flv player (allow 20px for controller)
var flvfullscreen = 'false' // Show fullscreen button, true or false (no auto return on Safari, double click in IE6)
...
var mp3imgmargin = '0'		// Mp3 button image css margins
...
Anarchy.Mp3 = {
	...
	go: function() {
		...
		for (var i = 0, o; o = all[i]; i++) {
			if(o.href.match(/\.mp3$/i) && o.className!="amplink") {
				...
				img.src = anarchy_url+'/images/audio_mp3_play.gif'; img.title = 'Escuchar Aquí '
				img.style.margin = mp3imgmargin
				img.style.border = 'none'
				img.style.cursor = 'pointer'
				img.className = 'listen'
	...
	toggle: function(img, url) {
		if (Anarchy.Mp3.playimg == img) Anarchy.Mp3.destroy()
			...
			Anarchy.Mp3.player.className='listen'
	...
	go: function() {
		...
		for (var i = 0, o; o = all[i]; i++) {
			if(o.href.match(/\.m4a$/i) && o.className!="amplink") {
				o.style.display = 'none'
				var img = document.createElement('img')
				img.src = anarchy_url+'/images/audio_mp4_play.gif'; img.title = 'Escuchar Aquí '
				img.style.margin = mp3imgmargin
				img.style.border = 'none'
				img.style.cursor = 'pointer'
