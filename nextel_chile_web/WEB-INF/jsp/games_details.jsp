...
<div id="content_games" class="content details">
	...
	<div id="description">
		<h3 class="cat">Categoría: Juegos</h3>
	...
	<div id="purchase"><a name="purchaseitem"></a>
		...
		<div id="sendtophone">
			...
			<div class="clear"></div>
			<a href="javascript:void 0;" onclick="sendToPhone('<%=phone%>','<%=phoneName%>','<%=loginStatus%>','games','01');return false;" class="send">ENVIAR</a>
			<%--
			<div class="select">
				<div class="selected">
					Lima
	...
	<div id="tellfriend">
		...
		<div id="tellfriendemail" class="hide">
			...
			<div class="clear"></div>
			<a href="javascript:void 0;" onclick="tellAFriend('<%=phone%>','<%=phoneName%>','<%=loginStatus%>','games','01');return false;" class="send">ENVIAR</a>
		</div>
