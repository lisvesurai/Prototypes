...
<%
if (tab.equals("receipt")) {
pageContext.forward( "games_receipt.jsp?u="+loginStatus+"&p="+phone+"&pn="+phoneName+"&priceModel="+priceModel );
}
%>
...
<jsp:include page="WEB-INF/template/virgin/header.jsp" flush="true"/>
					<div class="box_error">Error message goes here.</div>
					<jsp:include page="WEB-INF/jsp/games_detail.jsp" flush="true"/>
