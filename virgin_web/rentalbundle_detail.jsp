...
pageContext.forward( "rt_receipt.jsp?u="+loginStatus+"&p="+phone+"&pn="+phoneName+"&priceModel="+priceModel );
}
%>
...
<jsp:include page="WEB-INF/template/virgin/header.jsp" flush="true"/>
					<jsp:include page="WEB-INF/jsp/rentalbundle_detail.jsp" flush="true"/>
