			...
			<div class="col mid2">
				<div class="border2">
					<table cellspacing="0" class="styled4">
						<tr>
							<th colspan="6"><h4>Top Games</h4>
								<span><a href="games_by_genre.jsp?u=<%=loginStatus%>&p=<%=phone%>&pn=<%=phoneName%>&credit=<%=haveCredit%>&c=games">&gt; More</a></span></th>
						</tr>
					</table>
					<table cellspacing="0" class="styled5">
						<tr>
							...
							<td class="screenback"><p><a href="games_detail.jsp?u=<%=loginStatus%>&p=<%=phone%>&pn=<%=phoneName%>&credit=<%=haveCredit%>&c=games"><img src="_img/tetris.jpg" alt="Tetris" /></a><br />
									...
									$1.99 <span class="buy_now"><a href="games_buyConfirm.jsp?u=<%=loginStatus%>&p=<%=phone%>&pn=<%=phoneName%>&credit=<%=haveCredit%>&c=games">Buy Now</a></span></p></td>
