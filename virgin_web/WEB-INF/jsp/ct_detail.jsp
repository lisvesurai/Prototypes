					...
					<table cellspacing="0" cellpadding="0" border="0">
						<tr valign="top">
							<td class="c16_subSection_text">
								...
								<form action="ct_receipt.jsp" method="get">
								...
								<% } else { %>
								<form action="ct_buyConfirm.jsp" method="get">
									<strong>Buy this ringback tone <br/>
									<div id="priceDisplay">
									<% if (isPromo.equals("yes")) {%>
										<jsp:include page="ct_promo_price.jsp" flush="true"/>
									<% } else { %>
