					...
					<table cellspacing="0" cellpadding="0" border="0">
						<tr valign="top">
							<td class="c16_subSection_text">
								<p><strong>Disenchanted Lullaby</strong></p>
								<p>Content Type: Ringtone</p>
								<p>Order Number:  	10002</p>
								<p>Purchase Price: 	$2.50</p>
								...
								<p><a href="mypurchases_detail_rt.jsp?u=<%=loginStatus%>&p=<%=phone%>&pn=<%=phoneName%>&msg=9">Request Refund</a></p>
