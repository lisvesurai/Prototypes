<%@ include file = "../template/virgin/tools.jsp" %>
	...
	<div class="c16_subSection">
				<div class="bg_grey border_grey" style="padding: 8px;">
					<strong>Item:</strong>&nbsp;MapQuest Mobile <br/>
					<strong>Rental Bundle:</strong>&nbsp;Rental Bundle #2 Name<br/>
				</div>

				<p><b>You have 3 rental credits. <a href="mypurchases_detail_rentalbundle2.jsp?u=<%=loginStatus%>&p=<%=phone%>&pn=<%=phoneName%>&credit=<%=haveCredit%>&c=<%=contentType%>">Click here to manage your rentals.</a></b></p>
				
				<jsp:include page="recommendations.jsp" flush="true"/>
				<hr class="uline" />
				<br/>
				<p>Stay up on the latest Apps by signing up for App alerts.<br/>
