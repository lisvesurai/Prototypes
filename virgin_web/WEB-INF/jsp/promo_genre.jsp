				...
				<table cellspacing="0" class="styled3">
					<tr class="top">
						<td>
							<h3>Ringtones</h3>
								<ul class="first">
									<li><a href="rt_search_results.jsp?u=<%=loginStatus%>&p=<%=phone%>&pn=<%=phoneName%>&promo=yes">Dance &amp; Electronic</a></li>
									<li><a href="rt_search_results.jsp?u=<%=loginStatus%>&p=<%=phone%>&pn=<%=phoneName%>&promo=yes">Hip-Hop</a></li>
								</ul>
						</td>
						...
						<td>
							<h3>Apps</h3>
								<ul class="first">
									<li><a href="apps_by_genre.jsp?u=<%=loginStatus%>&p=<%=phone%>&pn=<%=phoneName%>&promo=yes">Entertainment</a></li>
									<li><a href="apps_by_genre.jsp?u=<%=loginStatus%>&p=<%=phone%>&pn=<%=phoneName%>&promo=yes">Mind, Body &amp; Soul</a></li>
									<li><a href="apps_by_genre.jsp?u=<%=loginStatus%>&p=<%=phone%>&pn=<%=phoneName%>&promo=yes">Travel Guides</a></li>
								</ul>
						</td>
						...
						<td>
							<h3>Graphics</h3>
								<ul class="first">
									<li><a href="wp_by_genre.jsp?u=<%=loginStatus%>&p=<%=phone%>&pn=<%=phoneName%>&promo=yes">Girls Stuff</a></li>
									<li><a href="wp_by_genre.jsp?u=<%=loginStatus%>&p=<%=phone%>&pn=<%=phoneName%>&promo=yes">Guys Stuff</a></li>
								</ul>
						</td>
					</tr>
				</table>
