<%@ include file = "../template/virgin/tools.jsp" %>
				...
				<div class="login">
				<h3>To <%=request.getParameter("actionTxt")%> this item, you'll have to login:</h3>
				...
				<a href="<%=contentType%>_receipt.jsp?u=in&p=<%=phone%>&pn=<%=phoneName%>&credit=<%=haveCredit%>&priceModel=<%=priceModel%>&type=<%=typeStr%>"><img src="images/virgin/but_submit.gif" class="bhv_button global_dropShadow" border="0"></a>
				</div>
