					...
					<table cellspacing="0" cellpadding="0" border="0">
						<tr valign="top">
							<td class="c16_subSection_text">
								<p><strong>Rental Bundle #1 Name</strong></p>
								<p>Content Type: Bundle</p>
								<p>Order Number:  	10006</p>
								...
								<% } else { %>
									...
									<p><a href="mypurchases_detail_rentalbundle.jsp?u=<%=loginStatus%>&p=<%=phone%>&pn=<%=phoneName%>&type=<%=typeStr%>&msg=8">Cancel Subscription</a></p>
									<p><a href="mypurchases_detail_rentalbundle.jsp?u=<%=loginStatus%>&p=<%=phone%>&pn=<%=phoneName%>&type=<%=typeStr%>&msg=9">Request Refund</a></p>
									<div id="AvailableItems" class="rentalItems">
									<jsp:include page="rentalbundle_available_items2.jsp" flush="true"/>
									</div>
								<% } %>
							</td>
						</tr>
