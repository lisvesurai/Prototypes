					...
					<table cellspacing="0" cellpadding="0" border="0">
						<tr valign="top">
							...
							<td class="c16_subSection_text">
								...
								High-RPM thrills! Race in tricked-out cars against 9 other drivers on tracks and street courses.
								<br/>
								<br/>
								<% if ((loginStatus.equals("in"))&&(haveCredit.equals("yes"))) { %>
								<form action="games_receipt.jsp" method="get">
								...
								<% } else { %>
								<form action="games_buyConfirm.jsp" method="get">
									<strong>Buy this app <br/>
									<div id="priceDisplay">
									<% if (isPromo.equals("yes")) {%>
										<jsp:include page="games_promo_price.jsp" flush="true"/>
									<% } else { %>
									<input type="radio" name="priceModel" class="priceModel" value="$5.99" checked />
									$5.99<br/>
									<input type="radio" name="priceModel" class="priceModel" value="$2.99/month subscription" />
									$2.99/month subscription<br/>
									<% } %>
									</div>
									</strong> <img src="images/virgin/0.gif" width="1" height="4" alt="" border="0"/><br/>
