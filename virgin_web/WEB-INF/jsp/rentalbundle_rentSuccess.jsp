<%@ include file = "../template/virgin/tools.jsp" %>
	...
	<div class="c16_subSection">
				<div class="bg_grey border_grey" style="padding: 8px;">
					...
					<strong>Rental Bundle:</strong>&nbsp;Rental Bundle #1 Name<br/>
					<strong>Sent to:</strong>&nbsp;(650) 814-4428<br/>
				</div>

				<p><b>You have 2 rental credits. <a href="mypurchases_detail_rentalbundle.jsp?u=<%=loginStatus%>&p=<%=phone%>&pn=<%=phoneName%>&credit=<%=haveCredit%>&c=<%=contentType%>">Click here to manage your rentals.</a></b></p>
