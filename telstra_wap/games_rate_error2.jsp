  ...
  <body>
    <div id="container">
      <jsp:include page="inc_header.jsp" flush="true">
		<jsp:param name="hdrImg" value="rate_review" />
		<jsp:param name="hdrTxt" value="Rate &amp; Review" />
	</jsp:include>

      <div id="body">
        <!--<hr/><h2 class="sh1">Games Info</h2>-->
		<%--<h2 class="bgh2"><img src="images/games/<%=screenWidth%>_h_rate_review.gif" alt="Rate &amp; Review"/></h2>--%>
        ...
        <hr/><div class="preview">
		  ...
		  <p class="msg">Please enter your nickname for your review to be listed.</p>		
			<form action='games_rate_save.jsp'>
