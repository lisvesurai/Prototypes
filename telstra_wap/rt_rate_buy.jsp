  ...
  <body>
    <div id="container">
      ...
      <div id="body">
	    ...
	    <h3 class="title">[Ringtone Title]</h3>
        ...
        <hr/><div class="preview">
		  ...
		  <p class="ratings">
			...
			<%--
			<p>You must buy this game in order to review it. <a href='rt_details.jsp?a=<%=userAgent%>&w=<%=screenWidth%>&f=<%=fontSize%>'>Click here to buy this game.</a></p>
			--%>
        </div>
		<div class="preview">
		</div>
