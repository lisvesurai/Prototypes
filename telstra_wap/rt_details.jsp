  ...
  <body>
    <div id="container">
      ...
      <div id="body">
	    ...
	    <h3 class="title">[Ringtone Title] (<span class="strikeoutTitlePrice">$7</span> <span class="discountPrice">$5</span>)</h3>
		...
		<h2 class="h3">Other Ringtones</h2>
        <div class="results">
		  <dl>
		...
		<h2 class="h3">Other people who bought this ringtone also bought</h2>
        <div class="results">
		  <dl>
			<dt class="mnr2">  <a href='rt_details.jsp?a=<%=userAgent%>&w=<%=screenWidth%>&f=<%=fontSize%>'>[Ringtone Title] ($7)</a> </dt>
			<dt class="mnr2">  <a href='rt_details.jsp?a=<%=userAgent%>&w=<%=screenWidth%>&f=<%=fontSize%>'>[Ringtone Title] ($7)</a> </dt>
          ...
          <dl class="page">
            <dt>
             &gt; <a href='rt_recommend.jsp?a=<%=userAgent%>&w=<%=screenWidth%>&f=<%=fontSize%>'>more</a>
            </dt>
          </dl>
		</div>
