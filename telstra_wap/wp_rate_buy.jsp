      ...
      <div id="body">
        ...
        <hr/><div class="preview">
		  ...
		  <p class="ratings">
			...
			<%--
			<p>You must buy this game in order to review it. <a href='wp_details.jsp?a=<%=userAgent%>&w=<%=screenWidth%>&f=<%=fontSize%>'>Click here to buy this game.</a></p>
			--%>
        </div>
		<div class="preview">
		</div>
