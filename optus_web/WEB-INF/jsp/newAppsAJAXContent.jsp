<%@ include file = "../template/optus/tools.jsp" %>
		...
		<div class="cbl">
			<div class="cbr">
				<div id="newAppsContent">
					<ul class="slider">
						<li class="first">
							<p class="img"><img src="/prototypes/placeholder/21.jpg" alt="" /><a href="apps_detail.jsp?ui=<%=strUI%>" class="maskfree">&nbsp;</a></p>
		...
		<span id="newAppsSelect">
			...
			<span class="next" onclick="ajaxLoader('WEB-INF/jsp/newAppsAJAXContent2.jsp','newAppsAJAXContent');"></span>
		</span>
