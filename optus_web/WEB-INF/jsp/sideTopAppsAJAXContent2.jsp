<%@ include file = "../template/optus/tools.jsp" %>
		...
		<span id="sideTopAppsSelect">
			<span class="prev" onclick="ajaxLoader('WEB-INF/jsp/sideTopAppsAJAXContent.jsp','sideTopAppsAJAXContent');"></span>
			<span class="next" onclick="ajaxLoader('WEB-INF/jsp/sideTopAppsAJAXContent3.jsp','sideTopAppsAJAXContent');"></span>
		</span>
