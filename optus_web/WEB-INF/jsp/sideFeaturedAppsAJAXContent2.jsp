<%@ include file = "../template/optus/tools.jsp" %>
		...
		<div class="cbl">
			<div class="cbr">
				<div id="sideFeaturedAppsContent">
					<ul class="slider">
						<li class="odd">
		...
		<span id="sideFeaturedAppsSelect">
			<span class="prev" onclick="ajaxLoader('WEB-INF/jsp/sideFeaturedAppsAJAXContent.jsp','sideFeaturedAppsAJAXContent');"></span>
			<span class="next" onclick="ajaxLoader('WEB-INF/jsp/sideFeaturedAppsAJAXContent3.jsp','sideFeaturedAppsAJAXContent');"></span>
		</span>
