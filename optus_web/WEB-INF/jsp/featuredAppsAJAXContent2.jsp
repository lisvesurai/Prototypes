<%@ include file = "../template/optus/tools.jsp" %>
		...
		<span id="featuredAppsSelect">
			<span class="prev" onclick="ajaxLoader('WEB-INF/jsp/featuredAppsAJAXContent.jsp','featuredAppsAJAXContent');"></span>
			<span class="next" onclick="ajaxLoader('WEB-INF/jsp/featuredAppsAJAXContent3.jsp','featuredAppsAJAXContent');"></span>
		</span>
