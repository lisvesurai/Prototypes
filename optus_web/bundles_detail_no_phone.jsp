...
<jsp:include page="WEB-INF/jsp/bundles_detail_no_phone.jsp" flush="true">
	<jsp:param name="p" value="no"/>
</jsp:include>

<jsp:include page="WEB-INF/template/optus/left_nav.jsp" flush="true">
	<jsp:param name="hl" value="hl"/>
	<jsp:param name="p" value="no"/>
</jsp:include>
<div class="clear"></div>
