...
<jsp:include page="inc_header.jsp" flush="true">
	...
	<jsp:param name="hl" value="0"/>
		...
		<h1 class="toptitle">Download Success<img src="singtelUI/img/arrow.gif" class="toptitle" /></h1>
		
		<div class="preview">
		  <p class="desc">
		  Thanks for your order. You have successfully downloaded Driving Log to your phone.</p>
		  <p class="msg">You will be charged $6 on your SingTel bill.</p>
		</div>

		<h1 class="toptitle">Recommendations<img src="singtelUI/img/arrow.gif" class="toptitle" /></h1>
