...
<jsp:include page="inc_header.jsp" flush="true"/>
	...
	<div class="content">
			...
			<table>
				<tr>
					...
					<td class="item" valign="top">
						...
						<p class="price"><b>FREE</b><br /><a href="receipt_free.jsp?w=<%=screenWidth%>&f=<%=fontSize%>"><img src="UI/img/<%=screenWidth%>/btn_download.gif" alt="Download" /></a></p>
						...
						<a href="item_free_rate.jsp?w=<%=screenWidth%>&f=<%=fontSize%>">Rate</a>
		...
		<div class="contentpad">
			<p class="price"><b>FREE</b> <a href="receipt_free.jsp?w=<%=screenWidth%>&f=<%=fontSize%>"><img src="UI/img/<%=screenWidth%>/btn_download.gif" alt="Download" /></a></p>
		</div>
