...
<jsp:include page="inc_header.jsp" flush="true"/>
	...
	<div class="content">
		...
		<div class="blocktitle2"><img src="UI/img/<%=screenWidth%>/t_search_results.gif" alt="Search results" /></div>
		<div class="contentpad">
			<p class="msg">XX matches found for ["search terms"] in [category].</p>
		...
		<div class="subtitle"><img src="UI/img/<%=screenWidth%>/mt_new_search.gif" alt="New search"/></div>
		<div class="contentpad">
...
<jsp:include page="inc_footer.jsp" flush="true">
	<jsp:param name="page" value="search_results"/>
</jsp:include>
