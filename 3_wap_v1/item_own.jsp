...
<jsp:include page="inc_header.jsp" flush="true"/>
	...
	<div class="content">
			...
			<table>
				<tr>
					...
					<td class="item" valign="top">
						...
						<p class="price"><b>$3.89</b><br /><a href="redownload.jsp?w=<%=screenWidth%>&f=<%=fontSize%>"><img src="UI/img/<%=screenWidth%>/btn_download.gif" alt="Download" /></a></p>
		...
		<div class="contentpad">
			<p class="price"><b>$3.89</b> <a href="redownload.jsp?w=<%=screenWidth%>&f=<%=fontSize%>"><img src="UI/img/<%=screenWidth%>/btn_download.gif" alt="Download" /></a>
		</div>
		<div class="link">
			<dl class="mnr">
				<% if (msg.equals("6")) { %>
				<dt class="mnr">&nbsp;&gt; <a href="item_own.jsp?w=<%=screenWidth%>&f=<%=fontSize%>&msg=7" class="mnr">Remove from wishlist</a></dt>
				<% } else { %>
				<dt class="mnr">&nbsp;&gt; <a href="item_own.jsp?w=<%=screenWidth%>&f=<%=fontSize%>&msg=6" class="mnr">Add to wishlist</a></dt>
				<% } %>
			</dl>
		</div>
